function K=StiffElasAssembling3DP1OptV0(nq,nme,q,me,volumes,lambda,mu,Num)
% function K=StiffElasAssembling3DP1OptV0(nq,nme,q,me,volumes,lambda,mu,Num)
...
% Example:
%    Th=CubeMesh(10);
%    KK=StiffElasAssembling3DP1OptV0(Th.nq,Th.nme,Th.q,Th.me,Th.volumes,1.,0.25,0);
%
% See also:
...
for k=1:nme
  I=GetI(me,k);
  K(I,I)=K(I,I)+ElemStiffElasMat(q(:,me(:,k)),volumes(k),H);
end
