function [Kg]=ElemStiffElasMatBaVecP1D0(q,me,volumes,lambda,mu)
%----------------------------------------
...
Kg(2,:)=(lambda+mu)*G{1}(1,:).*G{1}(2,:);%lambda.*G{1}(1,:).*G{1}(2,:) + mu.*G{1}(1,:).*G{1}(2,:);
Kg(3,:)=(lambda+mu)*G{1}(1,:).*G{1}(3,:); %lambda.*G{1}(1,:).*G{1}(3,:) + mu.*G{1}(1,:).*G{1}(3,:);
Kg(4,:)=(lambda + 2.*mu).*G{1}(1,:).*G{2}(1,:) + mu.*G{1}(2,:).*G{2}(2,:) + mu.*G{1}(3,:).*G{2}(3,:);
Kg(5,:)=lambda.*G{1}(1,:).*G{2}(2,:) + mu.*G{1}(2,:).*G{2}(1,:);
Kg(6,:)=lambda.*G{1}(1,:).*G{2}(3,:) + mu.*G{1}(3,:).*G{2}(1,:);
Kg(7,:)=(lambda + 2.*mu).*G{1}(1,:).*G{3}(1,:) + mu.*G{1}(2,:).*G{3}(2,:) + mu.*G{1}(3,:).*G{3}(3,:);
Kg(8,:)=lambda.*G{1}(1,:).*G{3}(2,:) + mu.*G{1}(2,:).*G{3}(1,:);
Kg(9,:)=lambda.*G{1}(1,:).*G{3}(3,:) + mu.*G{1}(3,:).*G{3}(1,:);
Kg(10,:)=(lambda + 2.*mu).*G{1}(1,:).*G{4}(1,:) + mu.*G{1}(2,:).*G{4}(2,:) + mu.*G{1}(3,:).*G{4}(3,:);
Kg(11,:)=lambda.*G{1}(1,:).*G{4}(2,:) + mu.*G{1}(2,:).*G{4}(1,:);
Kg(12,:)=lambda.*G{1}(1,:).*G{4}(3,:) + mu.*G{1}(3,:).*G{4}(1,:);
Kg(14,:)=(lambda + 2.*mu).*G{1}(2,:).^2 + mu.*G{1}(1,:).^2 + mu.*G{1}(3,:).^2;
Kg(15,:)=lambda.*G{1}(2,:).*G{1}(3,:) + mu.*G{1}(2,:).*G{1}(3,:);
Kg(16,:)=lambda.*G{1}(2,:).*G{2}(1,:) + mu.*G{1}(1,:).*G{2}(2,:);
Kg(17,:)=(lambda + 2.*mu).*G{1}(2,:).*G{2}(2,:) + mu.*G{1}(1,:).*G{2}(1,:) + mu.*G{1}(3,:).*G{2}(3,:);
Kg(18,:)=lambda.*G{1}(2,:).*G{2}(3,:) + mu.*G{1}(3,:).*G{2}(2,:);
Kg(19,:)=lambda.*G{1}(2,:).*G{3}(1,:) + mu.*G{1}(1,:).*G{3}(2,:);
Kg(20,:)=(lambda + 2.*mu).*G{1}(2,:).*G{3}(2,:) + mu.*G{1}(1,:).*G{3}(1,:) + mu.*G{1}(3,:).*G{3}(3,:);
Kg(21,:)=lambda.*G{1}(2,:).*G{3}(3,:) + mu.*G{1}(3,:).*G{3}(2,:);
Kg(22,:)=lambda.*G{1}(2,:).*G{4}(1,:) + mu.*G{1}(1,:).*G{4}(2,:);
Kg(23,:)=(lambda + 2.*mu).*G{1}(2,:).*G{4}(2,:) + mu.*G{1}(1,:).*G{4}(1,:) + mu.*G{1}(3,:).*G{4}(3,:);
Kg(24,:)=lambda.*G{1}(2,:).*G{4}(3,:) + mu.*G{1}(3,:).*G{4}(2,:);
Kg(27,:)=(lambda + 2.*mu).*G{1}(3,:).^2 + mu.*G{1}(1,:).^2 + mu.*G{1}(2,:).^2;
Kg(28,:)=lambda.*G{1}(3,:).*G{2}(1,:) + mu.*G{1}(1,:).*G{2}(3,:);
Kg(29,:)=lambda.*G{1}(3,:).*G{2}(2,:) + mu.*G{1}(2,:).*G{2}(3,:);
Kg(30,:)=(lambda + 2.*mu).*G{1}(3,:).*G{2}(3,:) + mu.*G{1}(1,:).*G{2}(1,:) + mu.*G{1}(2,:).*G{2}(2,:);
Kg(31,:)=lambda.*G{1}(3,:).*G{3}(1,:) + mu.*G{1}(1,:).*G{3}(3,:);
Kg(32,:)=lambda.*G{1}(3,:).*G{3}(2,:) + mu.*G{1}(2,:).*G{3}(3,:);
Kg(33,:)=(lambda + 2.*mu).*G{1}(3,:).*G{3}(3,:) + mu.*G{1}(1,:).*G{3}(1,:) + mu.*G{1}(2,:).*G{3}(2,:);
Kg(34,:)=lambda.*G{1}(3,:).*G{4}(1,:) + mu.*G{1}(1,:).*G{4}(3,:);
Kg(35,:)=lambda.*G{1}(3,:).*G{4}(2,:) + mu.*G{1}(2,:).*G{4}(3,:);
Kg(36,:)=(lambda + 2.*mu).*G{1}(3,:).*G{4}(3,:) + mu.*G{1}(1,:).*G{4}(1,:) + mu.*G{1}(2,:).*G{4}(2,:);
Kg(40,:)=(lambda + 2.*mu).*G{2}(1,:).^2 + mu.*G{2}(2,:).^2 + mu.*G{2}(3,:).^2;
Kg(41,:)=lambda.*G{2}(1,:).*G{2}(2,:) + mu.*G{2}(1,:).*G{2}(2,:);
Kg(42,:)=lambda.*G{2}(1,:).*G{2}(3,:) + mu.*G{2}(1,:).*G{2}(3,:);
Kg(43,:)=(lambda + 2.*mu).*G{2}(1,:).*G{3}(1,:) + mu.*G{2}(2,:).*G{3}(2,:) + mu.*G{2}(3,:).*G{3}(3,:);
Kg(44,:)=lambda.*G{2}(1,:).*G{3}(2,:) + mu.*G{2}(2,:).*G{3}(1,:);
Kg(45,:)=lambda.*G{2}(1,:).*G{3}(3,:) + mu.*G{2}(3,:).*G{3}(1,:);
Kg(46,:)=(lambda + 2.*mu).*G{2}(1,:).*G{4}(1,:) + mu.*G{2}(2,:).*G{4}(2,:) + mu.*G{2}(3,:).*G{4}(3,:);
Kg(47,:)=lambda.*G{2}(1,:).*G{4}(2,:) + mu.*G{2}(2,:).*G{4}(1,:);
Kg(48,:)=lambda.*G{2}(1,:).*G{4}(3,:) + mu.*G{2}(3,:).*G{4}(1,:);
Kg(53,:)=(lambda + 2.*mu).*G{2}(2,:).^2 + mu.*G{2}(1,:).^2 + mu.*G{2}(3,:).^2;
Kg(54,:)=lambda.*G{2}(2,:).*G{2}(3,:) + mu.*G{2}(2,:).*G{2}(3,:);
Kg(55,:)=lambda.*G{2}(2,:).*G{3}(1,:) + mu.*G{2}(1,:).*G{3}(2,:);
Kg(56,:)=(lambda + 2.*mu).*G{2}(2,:).*G{3}(2,:) + mu.*G{2}(1,:).*G{3}(1,:) + mu.*G{2}(3,:).*G{3}(3,:);
Kg(57,:)=lambda.*G{2}(2,:).*G{3}(3,:) + mu.*G{2}(3,:).*G{3}(2,:);
Kg(58,:)=lambda.*G{2}(2,:).*G{4}(1,:) + mu.*G{2}(1,:).*G{4}(2,:);
Kg(59,:)=(lambda + 2.*mu).*G{2}(2,:).*G{4}(2,:) + mu.*G{2}(1,:).*G{4}(1,:) + mu.*G{2}(3,:).*G{4}(3,:);
Kg(60,:)=lambda.*G{2}(2,:).*G{4}(3,:) + mu.*G{2}(3,:).*G{4}(2,:);
Kg(66,:)=(lambda + 2.*mu).*G{2}(3,:).^2 + mu.*G{2}(1,:).^2 + mu.*G{2}(2,:).^2;
Kg(67,:)=lambda.*G{2}(3,:).*G{3}(1,:) + mu.*G{2}(1,:).*G{3}(3,:);
Kg(68,:)=lambda.*G{2}(3,:).*G{3}(2,:) + mu.*G{2}(2,:).*G{3}(3,:);
Kg(69,:)=(lambda + 2.*mu).*G{2}(3,:).*G{3}(3,:) + mu.*G{2}(1,:).*G{3}(1,:) + mu.*G{2}(2,:).*G{3}(2,:);
Kg(70,:)=lambda.*G{2}(3,:).*G{4}(1,:) + mu.*G{2}(1,:).*G{4}(3,:);
Kg(71,:)=lambda.*G{2}(3,:).*G{4}(2,:) + mu.*G{2}(2,:).*G{4}(3,:);
Kg(72,:)=(lambda + 2.*mu).*G{2}(3,:).*G{4}(3,:) + mu.*G{2}(1,:).*G{4}(1,:) + mu.*G{2}(2,:).*G{4}(2,:);
Kg(79,:)=(lambda + 2.*mu).*G{3}(1,:).^2 + mu.*G{3}(2,:).^2 + mu.*G{3}(3,:).^2;
Kg(80,:)=lambda.*G{3}(1,:).*G{3}(2,:) + mu.*G{3}(1,:).*G{3}(2,:);
Kg(81,:)=lambda.*G{3}(1,:).*G{3}(3,:) + mu.*G{3}(1,:).*G{3}(3,:);
Kg(82,:)=(lambda + 2.*mu).*G{3}(1,:).*G{4}(1,:) + mu.*G{3}(2,:).*G{4}(2,:) + mu.*G{3}(3,:).*G{4}(3,:);
Kg(83,:)=lambda.*G{3}(1,:).*G{4}(2,:) + mu.*G{3}(2,:).*G{4}(1,:);
Kg(84,:)=lambda.*G{3}(1,:).*G{4}(3,:) + mu.*G{3}(3,:).*G{4}(1,:);
Kg(92,:)=(lambda + 2.*mu).*G{3}(2,:).^2 + mu.*G{3}(1,:).^2 + mu.*G{3}(3,:).^2;
Kg(93,:)=lambda.*G{3}(2,:).*G{3}(3,:) + mu.*G{3}(2,:).*G{3}(3,:);
Kg(94,:)=lambda.*G{3}(2,:).*G{4}(1,:) + mu.*G{3}(1,:).*G{4}(2,:);
Kg(95,:)=(lambda + 2.*mu).*G{3}(2,:).*G{4}(2,:) + mu.*G{3}(1,:).*G{4}(1,:) + mu.*G{3}(3,:).*G{4}(3,:);
Kg(96,:)=lambda.*G{3}(2,:).*G{4}(3,:) + mu.*G{3}(3,:).*G{4}(2,:);
Kg(105,:)=(lambda + 2.*mu).*G{3}(3,:).^2 + mu.*G{3}(1,:).^2 + mu.*G{3}(2,:).^2;
Kg(106,:)=lambda.*G{3}(3,:).*G{4}(1,:) + mu.*G{3}(1,:).*G{4}(3,:);
Kg(107,:)=lambda.*G{3}(3,:).*G{4}(2,:) + mu.*G{3}(2,:).*G{4}(3,:);
Kg(108,:)=(lambda + 2.*mu).*G{3}(3,:).*G{4}(3,:) + mu.*G{3}(1,:).*G{4}(1,:) + mu.*G{3}(2,:).*G{4}(2,:);
Kg(118,:)=(lambda + 2.*mu).*G{4}(1,:).^2 + mu.*G{4}(2,:).^2 + mu.*G{4}(3,:).^2;
Kg(119,:)=lambda.*G{4}(1,:).*G{4}(2,:) + mu.*G{4}(1,:).*G{4}(2,:);
Kg(120,:)=lambda.*G{4}(1,:).*G{4}(3,:) + mu.*G{4}(1,:).*G{4}(3,:);
Kg(131,:)=(lambda + 2.*mu).*G{4}(2,:).^2 + mu.*G{4}(1,:).^2 + mu.*G{4}(3,:).^2;
Kg(132,:)=lambda.*G{4}(2,:).*G{4}(3,:) + mu.*G{4}(2,:).*G{4}(3,:);
